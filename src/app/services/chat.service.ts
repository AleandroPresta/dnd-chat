...
export class ChatService {
    ...
    getChatRooms(): Observable<ChatRoom[]> {
        return this.http.get<ChatRoom[]>(`${this.apiUrl}/chat/rooms`, this.getHttpOptions());
    }

    // Get specific chat room with messages
    getChatRoom(roomId: string): Observable<ChatRoom> {
        return this.http.get<ChatRoom>(`${this.apiUrl}/chat/rooms/${roomId}`, this.getHttpOptions());
    }
